...
public class ItemBlockBase extends ItemBlock {
	 ...
	 * @param y Y position of final block place
	 * @param z Z position of final block place
	 * @param side Side of the block that was clicked
	 * @return
	 */
	...
	public boolean isSpaceEmpty(World w, int x, int y, int z) {
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        else if (p_77648_5_ == 255 && this.field_150939_a.getMaterial().isSolid())
        {
            return false;
        		...
        		&& canPlaceBlockAt(p_77648_1_, p_77648_2_, p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_, p_77648_7_))
        {
    ...
    public boolean func_150936_a(World p_150936_1_, int p_150936_2_, int p_150936_3_, int p_150936_4_, int p_150936_5_, EntityPlayer p_150936_6_, ItemStack p_150936_7_)
    {
        ...
        return p_150936_1_.canPlaceEntityOnSide(this.field_150939_a, p_150936_2_, p_150936_3_, p_150936_4_, false, p_150936_5_, (Entity)null, p_150936_7_)
        	   && canPlaceBlockAt(p_150936_7_, p_150936_6_, p_150936_1_, p_150936_2_, p_150936_3_, p_150936_4_, p_150936_5_);
    }
